...
<body class="simple-page bg-oxygen ">
    ...
    <div id="container">
      <div class="simple-page-wrap">
        ...
        <div class="simple-page-form" id="signup-form">
          ...
          <form id="login-form" method="post" autocomplete="off">
            ...
            <div class="form-group field-loginform-password required">
              ...
              <input type="password" id="loginform-password" class="password-hide-show form-control" name="password"
                tabindex="2" placeholder="Password" aria-required="true">

              <p class="help-block help-block-error"></p>
            </div>
            <div class="form-group m-b-xl field-loginform-rememberme">
              <div class="checkbox"><input type="hidden" name="LoginForm[rememberMe]" value="0"><input type="checkbox"
                  id="loginform-rememberme" name="LoginForm[rememberMe]" value="1"><label class="control-label"
                  for="loginform-rememberme">Remember me</label>
                <p class="help-block help-block-error"></p>
              </div>
            </div>
            <input type="submit" class="btn btn-primary input-100" name="login-button" value="Log In"></input>
          </form>
          <% if (messages.error) { %>
        ...
        <div class="simple-page-footer">
          <p>
            <a title="Forgot your password? Change it here!">Forgot your password?</a>
          </p>
          <p>
            <small>Don't have an account ?</small>
            <a href="/user/register" title="Sign up here!">Sign up here!</a>
          </p>
        </div>
  ...
  <script>jQuery(function ($) {
      ...
      //jQuery('#login-form').yiiActiveForm([{ "id": "loginform-username", "name": "username", "container": ".field-loginform-username", "input": "#loginform-username", "error": ".help-block.help-block-error", "encodeError": false, "enableAjaxValidation": true }, { "id": "loginform-password", "name": "password", "container": ".field-loginform-password", "input": "#loginform-password", "error": ".help-block.help-block-error", "encodeError": false, "enableAjaxValidation": false }, { "id": "loginform-rememberme", "name": "rememberMe", "container": ".field-loginform-rememberme", "input": "#loginform-rememberme", "error": ".help-block.help-block-error", "encodeError": false, "enableAjaxValidation": false }], []);
    });</script>
</body>
