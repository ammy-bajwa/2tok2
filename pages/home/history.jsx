...
export default function Index({}) {
  return (
    <div class="container" style="margin-top: 20px">
      {messages.success && (<div class="alert alert-success" role="alert">{messages.success}</div>)}
      {messages.error && (<div class="alert alert-danger" role="alert">{messages.error}</div>)}
      <div class="card">
        ...
        <div class="card-body">
          <div class="tab-content" id="nav-tabContent">
            ...
            >
              ...
              {!data?.withdrawals_data?.length && (<p class="text-center">No withdrawals!</p>)}
            </div>
          </div>
        </div>
      </div>
